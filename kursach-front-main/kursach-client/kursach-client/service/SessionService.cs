...
namespace kursach_client.service
{
    public class SessionService
    {
        ...
        public async Task<bool> CreateSessionAsync(Guid _sessionId, DateTime startTime)
        {
        ...
        public async Task StopSessionAsync(Guid _sessionId, DateTime startTime,DateTime stopTime)
        {
            var sessionData = new SessionRequest
            {
                id = _sessionId,
